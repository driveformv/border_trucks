...
export const metadata: Metadata = {
  title: "Fleetrite Truck Parts Las Cruces | Border International",
  description: "Visit our Fleetrite truck parts store in Las Cruces for quality truck parts and exceptional service. Located at 2701 W Amador Ave, Las Cruces, NM 88005.",
};

export default function FleetriteLasCruces() {
  return (
    <main className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Fleetrite Truck Parts Las Cruces</h1>
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-lg">2701 W Amador Ave</p>
                    <p className="text-gray-600">Las Cruces, NM 88005</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="h-6 w-6 text-blue-600" />
                  <a 
                    href="tel:+15755414259" 
        ...
        <div className="my-12 rounded-xl overflow-hidden shadow-lg">
          <GoogleMap address="2701 W Amador Ave, Las Cruces, NM 88005" />
        </div>

        <div className="prose max-w-3xl mx-auto">
          <h2>About Our Las Cruces Fleetrite Store</h2>
          <p>
            Our Las Cruces Fleetrite truck parts store offers a comprehensive selection of quality truck parts 
